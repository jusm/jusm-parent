package com.github.jusm.wx.pay.sdk;
...
public class WXPay {
	...
	public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
		if (!reqData.containsKey("appid") || StringUtils.isBlank(reqData.get("appid"))) {
			reqData.put("appid", config.getAppID());
		}
		if (!reqData.containsKey("mch_id") || StringUtils.isBlank(reqData.get("mch_id"))) {
			reqData.put("mch_id", config.getMchID());
		}
		if (!reqData.containsKey("nonce_str") || StringUtils.isBlank(reqData.get("nonce_str"))) {
	...
	public Map<String, String> unifiedOrder(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs)
		...
		if ((null == reqData.get("notify_url") || "".equals(reqData.get("notify_url").trim()))
				&& (this.notifyUrl != null && !"".equals(this.notifyUrl))) {
