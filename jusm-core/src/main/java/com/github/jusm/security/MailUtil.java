...
//	@Value("${mail.sendTo}")
	...
	public boolean sendMailSpring(String toAddress, String mailSubject, String mailBody, boolean mailBodyIsHtml,File[] attachments) {
		...
		try {
			...
			MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, ArrayUtils.isEmpty(attachments), "UTF-8"); // 设置utf-8或GBK编码，否则邮件会有乱码;multipart,true表示文件上传
	...
	public boolean sendMail (String[] toAddress, String mailSubject, String mailBody, 
        ...
        try {
			...
			MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, ArrayUtils.isEmpty(attachments), "UTF-8");
